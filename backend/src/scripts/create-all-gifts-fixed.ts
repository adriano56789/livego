...
// Todos os presentes do database.ts - VERSÃO CORRIGIDA
const allGifts = [
    // Popular
    ...
    { name: 'Trono Flutuante', price: 18000, icon: '✨', category: 'VIP' }, 
    { name: 'Jetpack', price: 5500, icon: '🚀', category: 'VIP' }, 
    { name: 'Aparição Fantasma', price: 4500, icon: '👻', category: 'VIP' }, 
    { name: 'Explosão de Flores', price: 3500, icon: '🌸', category: 'VIP' }, 
    { name: 'Caminho de Estrelas', price: 6500, icon: '⭐', category: 'VIP' }, 
    { name: 'Chegada de Submarino', price: 8000, icon: '🚘', category: 'VIP' }, 
    { name: 'Pouso de Pégaso', price: 15000, icon: '🦄', category: 'VIP' }, 
    { name: 'Teletransporte', price: 7000, icon: '🌀', category: 'VIP' }, 
    { name: 'Surfando na Onda', price: 6000, icon: '🏄', category: 'VIP' }, 
    { name: 'Skate Voador', price: 4000, icon: '🛹', category: 'VIP' }, 
    { name: 'Chegada de Tanque', price: 9000, icon: '💣', category: 'VIP' }, 
    { name: 'Nuvem Voadora', price: 3000, icon: '☁️', category: 'VIP' }, 
    { name: 'Carruagem Real', price: 11000, icon: '👑', category: 'VIP' }, 
    { name: 'Chegada de Submarino', price: 13000, icon: '🚘', category: 'VIP' }, 
    { name: 'Trono Flutuante', price: 18000, icon: '✨', category: 'VIP' },
