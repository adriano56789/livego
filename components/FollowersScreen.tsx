...
const FollowersScreen: React.FC<FollowersScreenProps> = ({ currentUser, onExit, onUpdateUser, ...modalProps }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true);
            try {
                const followerUsers = await authService.getFollowers(currentUser.id);
