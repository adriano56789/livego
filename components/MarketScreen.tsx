...
const MarketScreen: React.FC<MarketScreenProps> = ({ onClose, user, updateUser, onOpenWallet, onPurchaseFrame, addToast }) => {
  ...
  return (
    <div className="absolute inset-0 bg-[#212134] z-50 flex flex-col text-white font-sans">
      ...
      <main className="overflow-y-auto no-scrollbar p-4 z-10 flex flex-col">
        {activeTab === 'Quadro de avatar' ? (
            ...
            <div className="flex-grow flex items-center justify-center bg-black/20 rounded-lg">
                <p className="text-gray-500">Conteúdo para "{activeTab}" virá em breve.</p>
            </div>
        )}
      </main>
      ...
      <footer className="flex-shrink-0 p-4 z-10 border-t border-white/10 bg-[#212134]/80 backdrop-blur-sm">
        <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
                ...
                <button onClick={onOpenWallet} className="bg-yellow-400/20 w-6 h-6 rounded-full flex items-center justify-center">
