...
interface PrivatePartyBlockedScreenProps {
  onExit: () => void;
}

const PrivatePartyBlockedScreen: React.FC<PrivatePartyBlockedScreenProps> = ({ onExit }) => {
  return (
    <div className="fixed inset-0 z-50 bg-black/90 flex flex-col items-center justify-center text-white p-6 text-center font-sans">
        <div className="w-24 h-24 flex items-center justify-center bg-gray-800 rounded-full mb-6">
            <LockClosedIcon className="w-14 h-14 text-gray-400" />
        </div>
...
export default PrivatePartyBlockedScreen;