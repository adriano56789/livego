...
const SearchScreen: React.FC<SearchScreenProps> = ({ currentUser, onExit, onViewProfile }) => {
    ...
    <div className="h-screen w-full bg-black text-white flex flex-col font-sans">
      ...
      <main className="flex-grow overflow-y-auto scrollbar-hide">
        {isLoading ? (
          ...
          <div className="p-2">
            {results.map(user => (
              <button key={user.id} onClick={() => onViewProfile(user.id)} className="w-full text-left p-2 flex items-center gap-4 hover:bg-gray-800/50 transition-colors rounded-lg">
