...
import { User, Gift, Streamer, Message, NotificationSettings, BeautySettings, PurchaseRecord, EligibleUser, GoogleAccount, LiveSessionState, StreamHistoryEntry, LevelInfo, Order, LiveNotification, Invitation, DiamondPackage } from '../types';
...
// --- Interfaces removed because they shadow imports from ../types ---
...
export interface Fan { id: string; userId: string; fanId: string; createdAt: string; }
export interface Transaction { id: string; userId: string; amount: number; type: string; createdAt: string; }
