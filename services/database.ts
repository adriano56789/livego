...
const initialData = {
  ...
  pkBattles: [],
  gifts: [
    { _id: mongoObjectId(), id: 1, name: 'Coração', price: 1, valor_pontos: 1, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/heart_gift.png', iconComponent: 'HeartGift' },
    { _id: mongoObjectId(), id: 2, name: 'Rosa', price: 10, valor_pontos: 10, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/rose_gift.png', iconComponent: 'RoseGift' },
    { _id: mongoObjectId(), id: 3, name: 'Sorvete', price: 50, valor_pontos: 50, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/icecream_gift.png', iconComponent: 'IceCreamGift' },
    { _id: mongoObjectId(), id: 4, name: 'Foguete', price: 1000, valor_pontos: 1000, is_ativo: true, animationUrl: 'https://assets2.lottiefiles.com/packages/lf20_p8bfn5to.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/rocket_gift.png', iconComponent: 'RocketGift' },
    { _id: mongoObjectId(), id: 5, name: 'Carro', price: 5000, valor_pontos: 5000, is_ativo: true, animationUrl: 'https://assets5.lottiefiles.com/packages/lf20_l2k2mjbn.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/car_gift.png', iconComponent: 'SportsCar', soundUrl: 'https://storage.googleapis.com/genai-assets/livego/car_sound.mp3' },
    { _id: mongoObjectId(), id: 6, name: 'Castelo', price: 20000, valor_pontos: 20000, is_ativo: true, animationUrl: 'https://assets6.lottiefiles.com/packages/lf20_tijmpky4.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/castle_gift.png', iconComponent: 'CastleGift', soundUrl: 'https://storage.googleapis.com/genai-assets/livego/castle_sound.mp3' },
    { _id: mongoObjectId(), id: 7, name: 'Anel', price: 2000, valor_pontos: 2000, is_ativo: true, animationUrl: 'https://assets8.lottiefiles.com/packages/lf20_x2oiattv.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/ring_gift.png', iconComponent: 'RingGift', soundUrl: 'https://storage.googleapis.com/genai-assets/livego/ring_sound.mp3' },
    { _id: mongoObjectId(), id: 8, name: 'Iate', price: 50000, valor_pontos: 50000, is_ativo: true, animationUrl: 'https://assets1.lottiefiles.com/packages/lf20_b3dknkey.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/jet_gift.png', iconComponent: 'PrivateJet', soundUrl: 'https://storage.googleapis.com/genai-assets/livego/yacht_sound.mp3' },
    { _id: mongoObjectId(), id: 9, name: 'Pirulito', price: 5, valor_pontos: 5, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/lollipop_gift.png', iconComponent: 'Lollipop' },
    { _id: mongoObjectId(), id: 10, name: 'Donut', price: 25, valor_pontos: 25, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/donut_gift.png', iconComponent: 'Donut' },
    { _id: mongoObjectId(), id: 11, name: 'Patinho', price: 99, valor_pontos: 99, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/duck_gift.png', iconComponent: 'RubberDuck' },
    { _id: mongoObjectId(), id: 12, name: 'Microfone', price: 250, valor_pontos: 250, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/mic_gift.png', iconComponent: 'Microphone' },
    { _id: mongoObjectId(), id: 13, name: 'Controle', price: 499, valor_pontos: 499, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/controller_gift.png', iconComponent: 'GameController' },
    { _id: mongoObjectId(), id: 14, name: 'Baú', price: 999, valor_pontos: 999, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/chest_gift.png', iconComponent: 'TreasureChest' },
    { _id: mongoObjectId(), id: 15, name: 'Coração Dima', price: 1999, valor_pontos: 1999, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/diamondheart_gift.png', iconComponent: 'DiamondHeart' },
    { _id: mongoObjectId(), id: 16, name: 'Coroa', price: 4999, valor_pontos: 4999, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/crown_gift.png', iconComponent: 'CrownV2' },
    { _id: mongoObjectId(), id: 17, name: 'Esportivo', price: 9999, valor_pontos: 9999, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/car_gift.png', iconComponent: 'SportsCar' },
    { _id: mongoObjectId(), id: 18, name: 'Jato', price: 29999, valor_pontos: 29999, is_ativo: true, animationUrl: '', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/jet_gift.png', iconComponent: 'PrivateJet' },
    { _id: mongoObjectId(), id: 19, name: 'Panda Fofo', price: 888, valor_pontos: 888, is_ativo: true, animationUrl: 'https://assets5.lottiefiles.com/packages/lf20_ysbh2y2m.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/panda_gift.png', iconComponent: 'CutePanda' },
    { _id: mongoObjectId(), id: 20, name: 'Bomba Divertida', price: 199, valor_pontos: 199, is_ativo: true, animationUrl: 'https://assets2.lottiefiles.com/packages/lf20_O2OT6E.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/bomb_gift.png', iconComponent: 'FunnyBomb' },
    { _id: mongoObjectId(), id: 21, name: 'Poção do Amor', price: 699, valor_pontos: 699, is_ativo: true, animationUrl: 'https://assets6.lottiefiles.com/packages/lf20_gwmxftjc.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/potion_gift.png', iconComponent: 'LovePotion' },
    { _id: mongoObjectId(), id: 22, name: 'Guitarra de Rock', price: 2500, valor_pontos: 2500, is_ativo: true, animationUrl: 'https://assets1.lottiefiles.com/packages/lf20_p25qud2g.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/guitar_gift.png', iconComponent: 'RockGuitar' },
    { _id: mongoObjectId(), id: 23, name: 'Caixa Surpresa', price: 350, valor_pontos: 350, is_ativo: true, animationUrl: 'https://assets3.lottiefiles.com/packages/lf20_xmdoxc1o.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/jackinthebox_gift.png', iconComponent: 'JackInTheBox' },
    { _id: mongoObjectId(), id: 24, name: 'Unicórnio Mágico', price: 7500, valor_pontos: 7500, is_ativo: true, animationUrl: 'https://assets1.lottiefiles.com/packages/lf20_e2RV2J.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/unicorn_gift.png', iconComponent: 'MagicUnicorn' },
    { _id: mongoObjectId(), id: 25, name: 'Chuva de Dinheiro', price: 10000, valor_pontos: 10000, is_ativo: true, animationUrl: 'https://assets4.lottiefiles.com/packages/lf20_vgr58t0d.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/money_gift.png', iconComponent: 'MoneyRain' },
    { _id: mongoObjectId(), id: 26, name: 'Nave Espacial', price: 15000, valor_pontos: 15000, is_ativo: true, animationUrl: 'https://assets9.lottiefiles.com/packages/lf20_z01bika0.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/spaceship_gift.png', iconComponent: 'Spaceship' },
    { _id: mongoObjectId(), id: 27, name: 'Leão Rei', price: 25000, valor_pontos: 25000, is_ativo: true, animationUrl: 'https://assets8.lottiefiles.com/packages/lf20_y0pqpgw0.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/lion_gift.png', iconComponent: 'LionKing' },
    { _id: mongoObjectId(), id: 28, name: 'Dragão Lendário', price: 75000, valor_pontos: 75000, is_ativo: true, animationUrl: 'https://assets4.lottiefiles.com/packages/lf20_1nCoaD.json', imageUrl: 'https://storage.googleapis.com/genai-assets/livego/dragon_gift.png', iconComponent: 'LegendaryDragon' },
  ],
  diamondPackages: [
