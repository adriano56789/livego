      ...
      {activeStream && streamRoomData && currentUser ? (
        isPKBattleActive && pkOpponent ? (
          <PKBattleScreen 
            ...
            // FIX: Add missing onOpenVIPCenter prop
